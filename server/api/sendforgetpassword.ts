...
export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            subject: 'Welcome!',
            text: 'Hello, this is your code for forget password! Code: ' + code,
            html: '<b>Hello, this is your code for forget password! Code: ' + code + ' </b>',
        };

        await sqlInsert`
            UPDATE users SET forget_password_code = ${code} WHERE id = ${userResult[0].id}
        `;
